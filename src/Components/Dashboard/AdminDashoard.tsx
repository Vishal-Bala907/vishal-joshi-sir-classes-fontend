...
export const DashboardCard = ({ color, amount, text, children, arrow }: { arrow: string, color: string, amount: number, text: string, children: any }) => {
    return (
        <Card>
...
const AdminDashboard = () => {
    ...
    return (
        <Fragment>
            <Col xxl="3" xl="3" lg="3" md="4" sm="6" className="order-xxl-0 order-xl-2 box-col-6">
                <DashboardCard color={"success"} arrow='up-' amount={students?.length ?? 0} text={'Students'}>
                    <Icon icon="ph:student-bold" width="24" height="24" />
                </DashboardCard>
            </Col>
            <Col xxl="3" xl="3" lg="3" md="4" sm="6" className="order-xxl-0 order-xl-2 box-col-6">
                <DashboardCard color={"primary"} arrow='up-' amount={mentors?.length ?? 0} text={'Mentors'}>
                    <Icon icon="fa-solid:chalkboard-teacher" width="24" height="24" />
                </DashboardCard>
            </Col>
            <Col xxl="3" xl="3" lg="3" md="4" sm="6" className="order-xxl-0 order-xl-2 box-col-6">
                <DashboardCard color={"secondary"} arrow='down-' amount={admin?.length ?? 0} text={'Admins'}>
            ...
            <Col xxl="3" xl="5" lg="6" md="5" sm="12" className="order-xxl-0 order-xl-2 box-col-6">
